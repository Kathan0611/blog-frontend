...
const Register = () => {
  ...
  return (
    ...
    <div className='container shadow'>
      ...
      value ={input.username} className="form-control" id="formGroupExampleInput" placeholder="Enter Name" />
    </div>
  
  <div className='mb-3'>
      <label htmlFor='formGroupExampleInput' className='form-label'>Email</label>
      <input type="email" name="email"   value ={input.email}  onChange={(e)=>setInput({...input,[e.target.name]:e.target.value})}
       className="form-control" id="formGroupExampleInput" placeholder="Enter Email"/>
      </div>
      ...
      className="form-control" id="formGroupExampleInput" placeholder="Enter Password"/>
      </div>
